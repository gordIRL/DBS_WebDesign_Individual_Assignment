...
document.getElementById("contact_form").onsubmit   = function() { validateForm() };	
		...
		var surname 	= document.forms[0].surname.value.trim(); 
		var useremail 	= document.forms[0].useremail.value.trim(); 
		var phone 		= document.forms[0].phone.value.trim();
		
/*  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx	*/	

		if (first_name=="")
		{
			while (first_name.trim()=="")
					{						
						first_name = prompt("Name can't be blank - please enter again.")		
					} 
		}
...
/*  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx	*/		
		...
		if (surname=="")
		{
			while (surname.trim()=="")
					{						
						surname = prompt("Surname can't be blank - please enter again.")		
					} 
		}		
...
/*  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx	*/	
		...
		if (phone=="")
		{
			while (phone.trim()=="")
					{						
						phone = prompt("Phone number can't be blank - please enter again.")		
					} 
		}		
...
function changeTripAdvisorInfo() {	document.getElementById("trip_advisor").onclick = function() {tripAlert()};	}  	// end change_trip_advisor_info		
